...
export function NavbarDefault() {
  ...
  const navList = (
    <ul
      className={`mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 ${lusitana.className} antialiased`}
    >
      <Typography
        as="li"
        variant="small"
  ...
  return (
    <Navbar
      className={`mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4  ${lusitana.className} antialiased`}
      placeholder=""
      onPointerEnterCapture={() => {}}
      onPointerLeaveCapture={() => {}}
    >
